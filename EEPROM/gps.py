...
# Version of the L80K GPS app modified to work direct from EEPROM. (although you do need a larger EEPROM than that on the first production batch of hexpansions).
# See https://github.com/TechCabin/EMFBadge-Hexpansions-GPS for original code by TechCabin, and the README there for instructions on how to use this app.
