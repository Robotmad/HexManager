...
echo "If HexManager is checked out inside badge-2024-software, run tests with:"
echo "  cd tests"
echo "  PYTHONPATH=/path/to/badge-2024-software ../$VENV_PATH/bin/python -m pytest test_smoke.py -v"